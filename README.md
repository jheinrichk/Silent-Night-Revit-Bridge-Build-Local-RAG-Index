...
***v3-22 Bug Fix Update*** Silent Night Revit Bridge is a local LLM-to-Revit workflow that creates an autonomous Vision-Language-Action agentic loop between ChatGPT, the Revit Python Interactive Shell and Revit’s visual model state.
